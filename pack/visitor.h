...
public:
    ...
    static void visit(Node& node, const Resource& res)
    {
    ...
    static void visit(Attribute& node, const Resource& res)
    {
        switch (node.type()) {
            ...
            case Attribute::NodeType::Node:
                visit(static_cast<Node&>(node), res);
                break;
...
public:
    template <typename Resource>
    static void visit(const Node& node, Resource& res, Option opt)
    {
    ...
    static void visit(const Attribute& node, Resource& res, Option opt)
    {
        switch (node.type()) {
            ...
            case Attribute::NodeType::Map:
                ...
                break;
            case Attribute::NodeType::Node:
                visit(static_cast<const Node&>(node), res, opt);
                break;
            case Attribute::NodeType::Value:
